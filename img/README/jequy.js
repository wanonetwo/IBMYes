...
// 常用操作
  ...
  function oneclickImport(client, subLink) {
    ...
    var sublink = {
      ...
      quantumult: "quantumult://configuration?server=" + btoa(subLink).replace(/=/g, '') + "&filter=aHR0cHM6Ly9jZG4uanNkZWxpdnIubmV0L2doL3dhbm9uZXR3by9JQk1ZZXMvaW1nL1JFQURNRS9RdWFudHVtdWx0LmNvbmY=",
